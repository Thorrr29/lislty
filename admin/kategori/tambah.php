...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama_kategori)) {
        ...
        if ($stmt->fetch()) {
            ...
            $stmt = $pdo->prepare("INSERT INTO kategori (nama_kategori, deskripsi, warna) VALUES (?, ?, ?)");
            if ($stmt->execute([$nama_kategori, $deskripsi, $warna])) {
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" class="form-control form-control-color" id="warna" name="warna" 
                               value="<?php echo htmlspecialchars($warna ?? '#007bff'); ?>">
                    </div>
                </div>
